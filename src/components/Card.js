  ...
  return<div className="col-lg-4">
        <div className="card mb-5 mb-lg-0">
          <div className="card-body">
            ...
            <hr/>
            <ul className="fa-ul">
              <li className={props.card.userEnabler?"":'text-muted'}><span className="fa-li"><i className={props.card.userEnabler?"fas fa-check":"fas fa-times"}></i></span>{props.card.user}</li>
              ...
              <li className={props.card.subdomainEnabler?"":"text-muted"}><span className="fa-li"><i className={props.card.subdomainEnabler?"fas fa-check":"fas fa-times"}></i></span>{props.card.plan==='react-PRO'?<><b>Unliminted</b> {props.card.subdomain}</>:<>{props.card.subdomain}</>}</li>
